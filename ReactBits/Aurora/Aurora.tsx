...
export default function Aurora(props: AuroraProps) {
  const {
    colorStops = ["#8B0000", "#00008B", "#8B0000"],
    amplitude = 1.0,
    blend = 0.5,
    isDesktopOnly = true,
  } = props;
  ...
  const [isVisible, setIsVisible] = useState(!isDesktopOnly);
  ...
  useEffect(() => {
    ...
    if (geometry.attributes.uv) {
      try {
        ...
        console.warn("Could not delete UV attribute");
      }
    }
    if ((geometry.attributes as any).uv) {
      try {
        ...
        console.warn("Could not delete UV attribute (alternative)");
      }
    }
  ...
  }, [isVisible, amplitude, blend, colorStops]);
