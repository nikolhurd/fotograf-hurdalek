...
interface PricingSection3ColProps {
  title?: string;
  options: PricingOption[];
}

const PricingSection3Col: React.FC<PricingSection3ColProps> = ({
  title,
  options,
}) => {
  // Pokud nejsou žádné možnosti, nezobrazuj nic
